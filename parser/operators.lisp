...
(meta-sexp:defrule scanner (&aux val) ()
  (:? (:rule whitespace?))
  (:or (:and (:assign val (:rule string-literal?))
             (make-token :type :string :value val))
       (:and (:assign val (:rule boolean-literal?))
             (make-token :type :boolean :value val))
       (:and (:assign val (:rule datetime-literal?))
             (make-token :type :datetime :value val))
       (:and (:assign val (:rule date-literal?))
             (make-token :type :date :value val))
       (:and (:assign val (:rule numeric-literal?))
             (make-token :type :number :value val))
       (:and (:assign val (:rule operator?))
             (make-token :type :operator :value val))
       (:and (:assign val (:rule buffer-field?))
             (make-token :type :buffer-field :value val))
       (:and (:assign val (:rule identifier?))
             (make-token :type :identifier :value val))
       (:and (:assign val (:rule function-call?))
             (make-token :type :funcall :value val))
       (:and "(" (make-token :type :lparen :value "("))
       (:and ")" (make-token :type :rparen :value ")"))))
